...
public class BookingService {
  ...
  public Booking createBooking(Booking booking) {
    ...
    if (booking.getExpectedAttendees() > resource.getCapacity()) {
        throw new RuntimeException("Booking failed: Expected attendees exceed the resource capacity of " + resource.getCapacity() + ".");
    }
    ...
    public Booking rejectBooking(Long id, String note) {
        ...
        booking.getUserEmail(),
        "Booking Rejected",
        "Your booking for " + booking.getResourceName() + " on " + booking.getBookingDate() + " was rejected. Reason: " + note
);
        return bookingRepository.save(booking);
    }
